...
class getWeiboContent():
    ...
    def getBeginURL(self):
        begin_url = 'https://weibo.com/p/aj/v6/mblog/mbloglist?ajwvr=6&domain=100505&is_all=1&id=100505' + str(
            self.uid) + \
    ...
    def getContent(self, node):
        ...
        others = node.xpath(
            './/ul[@class="WB_row_line WB_row_r4 clearfix S_line2"]//span[@class="line S_line1"]/span/em[2]/text()')
